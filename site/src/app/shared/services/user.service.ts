...
export class UserListService {
  ...
  PointHistory(d) {
    return this.http.get<any>(usersApi + "/PointHistory", d);
  ...
  getFunabResult(d){
    return this.http.post<any>(usersApi + "/getFunabResult",d);

  }
  getAviatorResult(d){
    return this.http.post<any>(usersApi + "/getAviatorResult",d);
  ...
  getAdminfuntarget(d) {
    return this.http.get<any>(usersApi + "/getAdminfuntarget", d);
  ...
  getAdminroulette(d) {
    return this.http.get<any>(usersApi + "/getAdminroulette", d);
  ...
  getAdmintriplechance(d) {
    return this.http.get<any>(usersApi + "/getAdmintriplechance", d);
  ...
  gamerunningtriplechance(d) {
    return this.http.get<any>(usersApi + "/gamerunningtriplechance", d);
  ...
  getProfile() {
    return this.http.get<any>(usersApi + "/getProfile");

  }
  updateProfile(d) {
    return this.http.post<any>(usersApi + "/updateProfile",d);
