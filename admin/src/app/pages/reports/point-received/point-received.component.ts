...
@Component({
  selector: 'app-point-received',
  templateUrl: './point-received.component.html',
  styleUrls: ['./point-received.component.css']
})
export class PointReceivedComponent{
  tableRows: any = [];
...
report_name='/admin/report'
  ...
  getList() {
    ...
    this.service.PointReceived(filter).subscribe((d: any) => {
