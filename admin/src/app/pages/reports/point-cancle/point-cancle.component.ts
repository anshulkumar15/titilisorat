...
@Component({
  selector: 'app-point-cancle',
  templateUrl: './point-cancle.component.html',
  styleUrls: ['./point-cancle.component.css']
})
export class PointCancleComponent {
  tableRows: any = [];
...
report_name='/admin/report'
  ...
  getList() {
    ...
    this.service.PointCancel(filter).subscribe((d: any) => {
