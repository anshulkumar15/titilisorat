...
@Component({
  selector: 'app-point-rejected',
  templateUrl: './point-rejected.component.html',
  styleUrls: ['./point-rejected.component.css']
})
export class PointRejectedComponent {
  tableRows: any = [];
...
report_name='/admin/report'
  ...
  getList() {
    ...
    this.service.PointRejected(filter).subscribe((d: any) => {
