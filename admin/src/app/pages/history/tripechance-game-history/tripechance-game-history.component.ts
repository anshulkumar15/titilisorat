...
@Component({
  selector: 'app-tripechance-game-history',
  templateUrl: './tripechance-game-history.component.html',
  styleUrls: ['./tripechance-game-history.component.css']
})
export class TripechanceGameHistoryComponent {
  tableRows: any = [];
  ...
  report_name = '/admin/history/triplechance';
  ...
  getList() {
    ...
    this.service.getPlayer(filter).subscribe((d: any) => {
