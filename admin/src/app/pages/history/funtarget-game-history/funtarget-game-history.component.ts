...
@Component({
  selector: 'app-funtarget-game-history',
  templateUrl: './funtarget-game-history.component.html',
  styleUrls: ['./funtarget-game-history.component.css']
})
export class FuntargetGameHistoryComponent  {xa
  tableRows: any = [];
