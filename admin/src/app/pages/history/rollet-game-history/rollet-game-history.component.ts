...
@Component({
  selector: 'app-rollet-game-history',
  templateUrl: './rollet-game-history.component.html',
  styleUrls: ['./rollet-game-history.component.css']
})
export class RolletGameHistoryComponent  {
  tableRows: any = [];
  ...
  getList() {
    ...
    this.service.gamerunningroulette(filter).subscribe((d: any) => {
