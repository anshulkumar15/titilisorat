...
export class UserListService {
  ...
  getRolletResult(d){
    return this.http.post<any>(usersApi + "/getRolletResult",d);

  }
  getFuntartgetResult(d){
    return this.http.post<any>(usersApi + "/getFuntartgetResult",d);

  }
  getRolletRevenu(d){
    return this.http.post<any>(usersApi + "/getRolletRevenu",d);

  }
  getFuntartgetRevenu(d){
    return this.http.post<any>(usersApi + "/getFuntartgetRevenu",d);

  }
  getFuntargetRevenueTotal(d){
    return this.http.post<any>(usersApi + "/getFuntargetRevenueTotal",d);

  }
  getRolletRevenueTotal(d){
    return this.http.post<any>(usersApi + "/getRolletRevenueTotal",d);
  ...
  checkPointHistory(d) {
   ...
   getChildTotalProfit(d) {
    return this.http.post<any>(usersApi + "/getChildTotalProfit", d);
  ...
  getAgentRrofit(d) {
    return this.http.post<any>(usersApi + "/getAgentRrofit",d);
  }

  getDailyProfitReport(d) {
    return this.http.post<any>(usersApi + "/getDailyProfitReport",d);
  }
  getDailyPlayerWiseReport(d) {
    return this.http.post<any>(usersApi + "/getDailyPlayerWiseReport", d);

  }  
  getDatewiseReport(d) {
    return this.http.post<any>(usersApi + "/getDatewiseReport", d);
