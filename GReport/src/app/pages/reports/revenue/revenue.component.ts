...
export class RevenueComponent {
  ...
  report_name = '/reports/daily-status'
  totalRows = []
  ...
  getList() {
    ...
    this.service.getDatewiseReport(filter).subscribe((d: any) => {
  ...
  getPlayerTotal(){
    ...
    this.service.getDailyProfitReport(filter).subscribe((d: any) => {
      this.tableRows  = d.data;
      this.setPaginate(d);
    });
  }
  ...
  get totalAmount() {
    return this.tableRows.reduce((total, current) => total + current.profit, 0);
  }
}
