...
@Component({
  selector: 'app-fun-roullet',
  standalone: true,
  imports: [CommonModule, AccordianComponent, DialogComponent,NgxPaginationModule, FormsModule],
  templateUrl: './fun-roullet.component.html',
  styleUrl: './fun-roullet.component.scss'
})
export class FunRoulletComponent {
...
totalRows=[]
  ...
  getList() {
    ...
    this.service.getRolletResult(filter).subscribe((d: any) => {
